(function(){
    ...
    */
    function isOperatorValid(operadores){
        return !!operation[operadores];
    } 
    ...
    */
    function showOperationMessage(operador,numberr1,numberr2){
        return 'A operação ' + numberr1 + ' ' + operador + ' ' + numberr2 + ' = '; 
    }
