(function(){
  ...
  */
  ...
  console.log('21045852205'.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,'$1.$2.$3-$4'));
  console.log('73550079422'.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,'$1.$2.$3-$4'));
  console.log('10112313132'.replace(/(\d{3})(\d{3})(\d{3})(\d{2})/,'$1.$2.$3-$4'));
  /*
  ...
  */
  ...
  console.log('<h1>Título da página</h1>'.match(/<\w+>|<\/\w+>/g));
